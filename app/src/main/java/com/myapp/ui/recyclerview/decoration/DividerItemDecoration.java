package com.myapp.ui.recyclerview.decoration;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context, int orientation, float paddingStart,
        boolean rtl) {
        this.rtl = rtl;
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int top = child.getBottom() + params.bottomMargin + Math.round(
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final RecyclerView.LayoutParams params =
                (RecyclerView.LayoutParams) child.getLayoutParams();
            final int left = child.getRight() + params.rightMargin + Math.round(
